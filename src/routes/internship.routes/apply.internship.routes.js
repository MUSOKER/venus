...
const { deleteAppliedInternshipController, applyInternshipController } = require('../../controllers/internship/apply.internship.controller');
const internshipRoutes = require('./index');
