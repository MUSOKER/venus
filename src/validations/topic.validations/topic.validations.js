...
const addTopicValidation = Joi.object().keys({
  topic_name: enseedlingValidator.generic.string.any.required().label('Topic Name'),
  topic_description: enseedlingValidator.generic.string.any.required().label('Topic Description'),
  topic_duration: enseedlingValidator.generic.number.medium.required().label('Topic Duration'),
  totalVideos: enseedlingValidator.generic.number.medium.label('Total Videos'),
...
const updateTopicValidation = Joi.object().keys({
  ...
  topic_description: enseedlingValidator.generic.string.any.label('Topic Description'),
  topic_duration: enseedlingValidator.generic.number.medium.label('Topic Duration'),
  totalVideos: enseedlingValidator.generic.number.medium.label('Total Videos'),
  topic_info: enseedlingValidator.generic.string.medium.label('Topic Info'),
  demo_src: enseedlingValidator.generic.string.medium.label('Demo Src'),
